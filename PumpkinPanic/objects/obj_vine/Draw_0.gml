...
if(alarm[2] > 0){
	draw_sprite_ext(spr_vine_hit, -1, x, y,scale,scale,0,c_white,1);	
}else if(level == -1){
	draw_sprite_ext(spr_vine_dead, -1, x, y,scale,scale,0,c_white,1);	
}else{
	...
	draw_sprite_ext(spr_shrubbery, img, x, y,scale,scale,0,c_white,1);
	if(showVine)
	{
